...
export async function POST(request: Request) {
  ...
  // Return the assembled payload so the client can pass it directly to /api/notify
  // without re-assembling it on the frontend.
  return Response.json({ ok: true, lead_id: leadId, payload });
}
